...
public class Grid {
    ...
    /**
     * Note: Grid might be used by {@link GameObject}s during their initialization therefore
     * in order to avoid bugs it is advised to init {@link Grid} first.
     */
    public static Grid init(int screenWidth, int screenHeight, Vector center) {
    ...
    /**
     * This method should be called before each frame by GameEngine
